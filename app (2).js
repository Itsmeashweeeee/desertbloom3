...
function dailyReset() {
  ...
  tasks.forEach(t => { if (t.repeat === 'daily') t.status = 'pending'; });
...
function renderHome() {
  ...
  drawCactus('mini-cactus', 64, 80, getLevel().level, streak, true);
}
...
function renderSettings() {
  ...
  drawCactus('main-cactus', 300, 300, level, streak, false);
